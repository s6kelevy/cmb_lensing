...
def specs(experiment): 
    ...
    if experiment == 'so':
        specs_dic = {
            ...
            #27:  [7.4, 52.1, 0,  1000, -3.5],
            #39:  [5.1, 27.1, 0,  1000, -3.5], 
            #93:  [2.2, 5.8,  0,  1000, -3.5],
            #145: [1.4, 6.5,  0, 1000, -3.5],
            #225: [1.0, 15.0, 0, 1000, -3.5],
            #280: [0.9, 37.0, 0, 1000, -3.5],
            }
    ...
    if experiment == 'ccatp':
        specs_dic = {
            ...
            #93:  [2.2, 5.8,  0,  1000, -3.5],
            #145: [1.4, 6.5,  0, 1000, -3.5],
            #220: [0.95, 14.6, 0, 1000, -3.5],
            #225: [1.0, 15.0, 0, 1000, -3.5],
            #279.999999: [0.9, 37.0, 0, 1000, -3.5],
            #280: [0.75, 27.5, 0, 1000, -3.5], 
            #350: [0.58, 104.8, 0, 1000, -3.5],
            #410: [0.50, 376.6, 0, 1000, -3.5]             
            }
    ...
    if experiment == 's4wide':
        specs_dic = {
            ...
            #27: [7.4, 21.5, 0, 415, -3.5],
            #39: [5.1, 11.9, 0, 391, -3.5], 
            #93: [2.2, 1.9, 0, 1932, -3.5],
            #145: [1.4, 2.1, 0, 3917, -3.5],
            #225: [0.9, 6.9, 0, 6740, -3.5],
            #278: [0.7, 16.8, 0, 6792, -3.5],
            }   
        corr_noise_bands = {27:[39], 39:[27], 93:[145], 145:[93], 225: [278], 278: [225]}
        rho = 0.9
        
        
    if experiment == 'ccatp2':
        specs_dic = {
            #freq: [beam_arcmins, white_noise, red_noise, elknee, alphaknee] 
