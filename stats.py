...
def run_ml(data = None, models = None, param_int = None, make_finer = 1, howmanysamples = 1000000, which_percentile = 16., likelihood = None):
    if likelihood is None:
        likelihood = likelihood_function(data,  models, param_int)
    x, likelihood_curve = likelihood
